...
namespace Code.Gameplay.Map.Systems
{
    public class MapInitializeSystem : IInitializeSystem
    {
        ...
        {
            CreateTower(Vector3.zero + Vector3.left * 0.5f + Vector3.back * 0.5f, TowerFractionsEnum.Blue, 5, TowerTypesEnum.Tower);
            CreateTower(Vector3.zero + Vector3.right * 0.5f + Vector3.back * 0.5f, TowerFractionsEnum.Blue, 8, TowerTypesEnum.Tower);
            CreateTower(Vector3.zero + Vector3.left * 0.5f + Vector3.forward * 0.5f, TowerFractionsEnum.Red, 17, TowerTypesEnum.Tower);
        }
