...
{
    public class RouteAdjustmentOnCreateOppositeRS : ReactiveSystem<GameEntity>
    {
        private readonly GameContext _game;

        public RouteAdjustmentOnCreateOppositeRS(IContext<GameEntity> context) : base(context)
        {
