...
{
    public class FinishCreationRouteRS : ReactiveSystem<GameEntity>
    {
        private readonly CommonStaticData _commonStaticData;
        private readonly GameContext _game;
        
        public FinishCreationRouteRS(IContext<GameEntity> context, CommonStaticData commonStaticData) : base(context)
        {
