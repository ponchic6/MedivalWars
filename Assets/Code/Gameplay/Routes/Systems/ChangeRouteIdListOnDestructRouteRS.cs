...
{
    public class ChangeRouteIdListOnDestructRouteRS : ReactiveSystem<GameEntity>
    {
        private readonly GameContext _game;

        public ChangeRouteIdListOnDestructRouteRS(IContext<GameEntity> context) : base(context)
        {
