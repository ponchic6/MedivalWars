...
{
    public class RouteByDestructAdjustmentViewReactiveSystem : ReactiveSystem<GameEntity>
    {
        private readonly GameContext _game;

        public RouteByDestructAdjustmentViewReactiveSystem(IContext<GameEntity> context) : base(context)
        {
        ...
        protected override void Execute(List<GameEntity> entities)
        {
            foreach (GameEntity destructedRoute in entities)
            {
                ...
                if (!CheckReverseRoadExist(completedRoutes, destructedRoute, out var oppositeRoute))
                    continue;
        ...
        private bool CheckReverseRoadExist(IGroup<GameEntity> completedRoutes, GameEntity destructedRoute, out GameEntity oppositeRoute)
        {
