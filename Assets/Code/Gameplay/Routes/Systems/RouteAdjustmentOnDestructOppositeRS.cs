...
{
    public class RouteAdjustmentOnDestructOppositeRS : ReactiveSystem<GameEntity>
    {
        private readonly GameContext _game;

        public RouteAdjustmentOnDestructOppositeRS(IContext<GameEntity> context) : base(context)
        {
